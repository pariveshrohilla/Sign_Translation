...
5. Create a folder names as Images with subfolders of all alphabets and digits
6. copy collectdata.py and run it to save your images into a file named as Images 
